...
class User(AbstractUser):
    ...
    photo = models.ForeignKey('Document', on_delete=models.SET_NULL, null=True, verbose_name="User Photo ID")
    user_type = models.CharField(max_length=3, choices=USER_TYPE_CHOICES, default='Stu', verbose_name="User Type")
...
class MedicalHistory(models.Model):
    ...
    category = models.CharField(max_length=1, choices=CATEGORY_CHOICES, verbose_name="Category")
...
class Schedule(models.Model):
    ...
    day = models.CharField(max_length=3, choices=DAY_CHOICES, verbose_name="Day of Visit")
...
class Appointment(models.Model):
    ...
    schedule = models.ForeignKey('Schedule', on_delete=models.CASCADE, verbose_name="Schedule ID")
    user = models.ForeignKey('User', on_delete=models.CASCADE, verbose_name="User ID")
...
class Diagnosis(models.Model):
    appointment = models.ForeignKey('Appointment', on_delete=models.CASCADE, verbose_name="Appointment ID")
...
class Prescription(models.Model):
    diagnosis = models.ForeignKey('Diagnosis', on_delete=models.CASCADE, verbose_name="Diagnosis ID")
    inventory = models.ForeignKey('Inventory', on_delete=models.CASCADE, verbose_name="Inventory ID")
...
class Transaction(models.Model):
    user = models.ForeignKey('User', on_delete=models.CASCADE, verbose_name="User ID")
    inventory = models.ForeignKey('Inventory', on_delete=models.CASCADE, verbose_name="Inventory ID")
    prescription = models.ForeignKey('Prescription', on_delete=models.CASCADE, verbose_name="Prescription ID")
...
class Emergency(models.Model):
    ...
    location = models.CharField(max_length=3, choices=LOCATION_CHOICES, verbose_name="Location")
...
class MedicalCertificate(models.Model):
    diagnosis = models.ForeignKey('Diagnosis', on_delete=models.CASCADE, verbose_name="Diagnosis ID")
    document = models.ForeignKey('Document', on_delete=models.CASCADE, verbose_name="Document ID")
